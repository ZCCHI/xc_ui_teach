...
//使用工具类将json对象转成key/value
  ...
  return http.requestPost(apiUrl+"/course/coursebase/list/"+page+"/"+size+"?"+queries)
}

//查询课程分类
export const category_findlist= () => {
  return http.requestQuickGet(apiUrl+'/category/category/list')
}
/*添加课程基础信息*/
...
export const updateCoursebase = (id,params) =>{
  return http.requestPost(apiUrl+'/course/updatecoursebase/'+id,params)

}

export const updateCourseMarket = (id,params) => {
  return http.requestPost(apiUrl+'/course/coursemarket/add/'+id,params);
}
